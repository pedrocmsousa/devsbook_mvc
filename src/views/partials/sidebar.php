<aside class="mt-10">
    <nav>
        ...
        <a href="<?= $base ?>/profile">
            <div class="menu-item <?= $activeMenu == 'profile'
                ? 'active'
                : '' ?>">
                <div class="menu-item-icon">
        ...
        <a href="<?= $base ?>/friends">
            <div class="menu-item <?= $activeMenu == 'friends'
                ? 'active'
                : '' ?>">
                <div class="menu-item-icon">
        ...
        <a href="<?= $base ?>/photos">
            <div class="menu-item <?= $activeMenu == 'photos'
                ? 'active'
                : '' ?>">
                <div class="menu-item-icon">
        ...
        <a href="<?= $base ?>/settings">
            <div class="menu-item <?= $activeMenu == 'settings'
                ? 'active'
                : '' ?>">
                <div class="menu-item-icon">
